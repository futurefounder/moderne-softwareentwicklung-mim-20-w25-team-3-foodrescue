...
public final class AngebotsId {
    ...
    public static AngebotsId of(String value){ return new AngebotsId(value); }
    public String value(){ return value; }
    @Override public String toString(){ return value; }
    @Override public boolean equals(Object o){ return o instanceof AngebotsId id && value.equals(id.value); }
